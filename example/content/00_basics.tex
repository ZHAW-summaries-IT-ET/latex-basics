...
\begin{concept}{Concept Title}
    This is a concept. This describes more general concepts and ideas. NOT EVERYTHING IS A CONCEPT THOUGH!
    \begin{itemize}
        \item two lists usually fit next to each other
        \item use the custom command mult for that 
    \end{itemize}
    Please also use other box types, to make the summary more readable. If too many boxes of the same type (aka the same colour) are on one page, it becomes very messy.
    So concepts should be the BASE concepts, further explanations/details or subconcepts should be theorems or corollaries, or sometimes just definitions.
\end{concept}
...
\begin{theorem}{Topic A}
    this is a theorem regarding topic A. Or a subconcept/conclusion from the concept above.
\end{theorem}

\begin{corollary}{Topic A}
    this is a corollary regarding topic A. Or some details on the concept above.
\end{corollary}
...
\begin{definition}{Definition Title}
    ...
    \\
    before and after an image, we need to add a new line manually. unless there is nothing below it.
    \\
    \includegraphics[width=\linewidth]{binomtrick.png}
\end{definition}
